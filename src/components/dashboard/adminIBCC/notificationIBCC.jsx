...
import { useSendIBCCNotification } from "@/hooks/Admin/useHandleAdminIBCC";

const NotificationIBCC = () => {
  const [formData, setFormData] = useState({
    subject: "",
    message: ``,
  });

  const { sendNotification, isLoading } = useSendIBCCNotification();
...
export default NotificationIBCC;
