...
import { useGetIBCCParticipants } from "@/hooks/Admin/useHandleAdminIBCC";
...
const ParticipantsIBCC = () => {
  ...
  const { data: allParticipants } = useGetIBCCParticipants();
  ...
  const handleAnnounceClick = () => {
    navigate("/dashboard/ibcc/announcement");
  };

  const handleNotificationClick = () => {
    navigate("/dashboard/ibcc/notifications");
  };

  const handleParticipantsClick = () => {
    navigate("/dashboard/ibcc/participants");
  };

  const handleTeamVerificationClick = () => {
    navigate("/dashboard/ibcc");
  };

  const handleGeneralVerificationClick = () => {
    navigate("/dashboard/ibcc/general-verification");
  };
...
export default ParticipantsIBCC;