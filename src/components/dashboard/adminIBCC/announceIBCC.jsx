...
import {
	useSendIBCCAnnouncement,
	useSendIBCCAnnouncementAll,
...
const AnnounceIBCC = () => {
	...
	const { isLoading, sendAnnouncement } = useSendIBCCAnnouncement();
	...
	return (
		<>
			...
			<div className="min-h-screen flex flex-col md:flex-row md:mt-20">
				...
				{/* Main content */}
				<div className="flex-1 p-4 md:p-6 md:ml-8">
					{/* Main content */}
