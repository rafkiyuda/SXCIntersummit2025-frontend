...
import { useSendIBPCNotification } from "@/hooks/Admin/useHandleAdminIBPC";

const NotificationIBPC = () => {
  const [formData, setFormData] = useState({
    subject: "",
    message: ``,
  });

  const { sendNotification, isLoading } = useSendIBPCNotification();
  ...
  const handleSendNotificationToAll = () => {
    ...
    sendNotification({ title: formData.subject, message: formData.message });
...
export default NotificationIBPC;
