...
const navigationItems = [
  { icon: Users, label: "Participants", path: "/dashboard/bcl/" },
  {
    icon: CheckCircle,
    label: "Verification",
    path: "/dashboard/bcl/verification",
  },
  { icon: Megaphone, label: "Announce", path: "/dashboard/bcl/announce" },
  { icon: Bell, label: "Notifications", path: "/dashboard/bcl/notifications" },
];
    ...
    <>
      ...
      <div className="md:hidden w-full bg-gradient-to-r from-[#562780] via-[#643D87] to-[#8257A9] p-4 space-y-4">
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 text-center">
          ...
          <div className="text-white font-semibold">ADMIN BCL</div>
