...
const ProjectOfficer = () => {
  ...
  const [currentPage, setCurrentPage] = useState("chambers");
  ...
  const filteredData = useMemo(() => {
    ...
    return participantData.filter((item) => {
      return (
        ...
        item.domicile.toLowerCase().includes(searchLower) ||
        ...
        item.lineId.toLowerCase().includes(searchLower) ||
  ...
  const ProjectButton = ({ project }: { project: string }) => {
  ...
  const MobileProjectMenu = () => (
    <div
      ...
      } absolute top-full left-0 right-0 z-50 bg-purple-800 border-t border-purple-600`}
    >
      <div className="p-4">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-600 via-purple-700 to-purple-800">
      {/* Header */}
      <header className="relative bg-purple-700 px-4 sm:px-6 py-4">
        <div className="flex flex-col lg:flex-row lg:justify-between lg:items-center space-y-4 lg:space-y-0">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="min-w-0">
                ...
                <p className="text-purple-200 text-xs sm:text-sm">
                  Managed by:{" "}
                  <span className="text-white">Manager of Program</span>
                  <br className="hidden sm:block" />
                  <span className="text-purple-300 block sm:inline">
                    {" "}
                    MoP@gmail.com
                  </span>
                </p>
          ...
          <div className="relative w-56 lg:mx-2">
            <div className="relative">
              ...
              <button className="absolute right-2 top-1/2 -translate-y-1/2 bg-white/20 p-1.5 rounded hover:bg-white/30 transition-colors">
                <svg
          ...
          <div className="flex items-center space-x-3">
            ...
            <div className="flex flex-col items-center space-y-1.5">
              ...
              <button className="bg-red-500 hover:bg-red-600 text-white px-2.5 py-1 rounded flex items-center space-x-1.5 text-xs transition-colors">
                <img
      ...
      {searchTerm && (
        <div className="px-4 sm:px-6 py-2 bg-purple-600/50">
          <p className="text-white/80 text-sm">
            Showing {filteredData.length} of {participantData.length}{" "}
            participants
            ...
            <table className="w-full">
              <thead>
                <tr className="bg-[#8257b8]">
                  ...
                  <th className="text-left py-3 px-4 text-white font-medium text-sm">
                    Name
                  </th>
                  <th className="text-left py-3 px-4 text-white font-medium text-sm">
                    Email
                  ...
                  filteredData.map((participant, index) => (
                    ...
                    >
                      ...
                      <td className="py-3 px-4">
                        <button
                          onClick={() => handlePreview(index)}
                          className="flex items-center space-x-1 bg-purple-800 hover:bg-purple-900 px-2 py-1 rounded text-white text-sm transition-colors"
                        >
                          <Eye className="w-3 h-3" />
                          <span>Preview</span>
                        </button>
