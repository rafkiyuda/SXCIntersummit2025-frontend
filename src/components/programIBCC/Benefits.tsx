...
const benefitCards = [
  { src: '/images/programpage/ibcc/ECertificate.png', alt: 'E-Certificate Benefit' },
  { src: '/images/programpage/ibcc/PrizeMoney.png', alt: 'Prize Money Benefit' },
  { src: '/images/programpage/ibcc/Networking.png', alt: 'Networking Benefit' },
  { src: '/images/programpage/ibcc/InternationalExposure.png', alt: 'International Exposure Benefit' },
  { src: '/images/programpage/ibcc/IndustriesExposure.png', alt: 'Industries Exposure Benefit' },
];
    ...
    <section className="py-10 md:py-24">
      <div className="container mx-auto max-w-7xl px-2 md:px-4">
        ...
        <div className="flex flex-col gap-6 md:gap-12">
          ...
          {/* Bottom Cards */}
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-8 justify-center items-center">
