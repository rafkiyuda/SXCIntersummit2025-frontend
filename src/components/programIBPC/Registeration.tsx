...
const Registration: React.FC = () => {
  ...
  const targetDate = new Date("October 16, 2025 23:59:59");
  ...
  const handleRegister = () => {
    if (!user) {
      ...
      if (data?.some((a) => a.programId === 4)) {
        navigate("/profile/home/ibpc/preliminary");
      } else {
        navigate("/profile/home/ibpc/register");
      }
    }
  };
      ...
      <div className="flex flex-col items-center justify-center text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <button
            ...
            onClick={() => window.open("https://drive.google.com/drive/folders/1dP058MvJeKt_WFeCC2zocoeMJSt39VmA?usp=sharing", "_blank")}
          >
