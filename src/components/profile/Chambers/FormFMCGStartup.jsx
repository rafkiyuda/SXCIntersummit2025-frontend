...
const DayTwo = () => {
	...
	const handleRegister = () => {
		if (!user) {
			...
			if (data?.some((a) => a.programId === 5 && a.type === "DAY2")) {
	...
	const handleSubmit = async () => {
		...
		await Promise.all([
			submitForm({ formData: formData, day: "DAY2" }),
			...
			<div className="relative bg-white rounded-3xl shadow-2xl max-w-md w-full mx-4 overflow-hidden">
				...
				<div className="p-6 pt-12">
					...
					<button
						...
						className="w-full bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 cursor-pointer text-white font-semibold py-4 px-6 rounded-xl text-lg transition-all duration-200 shadow-lg"
					>
						Continue
					</button>
				</div>
							...
							<div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 lg:p-8 border border-white/20">
								...
								<div className="space-y-6">
									...
									<button
										...
										className="w-full flex items-center justify-center bg-gradient-to-r from-[#C4EF7B] to-[#7C9F42] hover:from-[#C4EF7B] hover:to-[#7C9F42] disabled:from-gray-400 disabled:to-gray-500 disabled:cursor-not-allowed cursor-pointer text-white font-semibold py-4 px-6 rounded-lg text-lg transition-all duration-200 shadow-lg"
									>
