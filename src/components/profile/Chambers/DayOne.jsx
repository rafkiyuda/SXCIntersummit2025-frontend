...
const BenefitCard = ({ icon: Icon, title }) => (
	<div className="bg-gradient-to-br from-purple-500/30 to-purple-600/30 backdrop-blur-sm rounded-2xl p-4 border border-white/20 text-center">
...
const Dashboard = () => {
	...
	const day2Joined = data?.some((a) => a.programId === 5 && a.type === "DAY2");
	return (
			...
			<div className="max-w-3xl mx-auto">
				...
				<header className="mb-8">
					<div className="flex justify-between items-end max-md:flex-col max-md:items-start">
						...
						{day2Joined && (
							<p
								onClick={() => navigate("/profile/home/chambers/fmcg-startup")}
							...
							<div className="space-y-4">
								...
								<EventInfo icon="🎯" label="Theme">
									<span className="italic">
										...
										Harnessing Digital
										<br />
										Transformation in Consulting and
										<br />
										Financial Services
									</span>
								</EventInfo>
							...
							<div className="grid grid-cols-1 md:grid-cols-2 gap-8">
								<div className="text-center">
									<div className="w-32 h-32 bg-gray-300 rounded-2xl mb-4 overflow-hidden mx-auto">
										<img
											src="/images/profile/Chambers/speakers/AthiraPutriandari.svg"
						...
						<Card title="">
							...
							<div>
								...
								<button
									...
									className="w-full bg-green-500 hover:bg-green-600 text-white font-bold py-3 px-4 rounded-xl flex items-center justify-center space-x-2 transition-colors"
								>
