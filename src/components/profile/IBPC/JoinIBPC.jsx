...
import { useJoinIBPCteam } from "@/hooks/User/useHandleIBPC";
...
const JoinIBPC = () => {
	...
	const { isLoading, joinIBPCteam } = useJoinIBPCteam();
	const handleJoinTeam = () => {
		// Handle team joining logic here
		// ;
		joinIBPCteam({ code: teamCode });
	};
