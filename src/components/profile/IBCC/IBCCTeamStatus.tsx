...
const IBCCTeamStatus = () => {
  ...
  const { isLoading, data: teamDetailsData } = useGetIBCCTeamDetails();
  ...
  const teamStatus = getTeamStatus(teamDetailsData?.status); // Get the current team status
