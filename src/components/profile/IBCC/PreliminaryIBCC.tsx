...
import Timeline from "./timelineIBCC";
import Announcement from "@/pages/user/Announcement";
import IBCCTeamStatus from "./IBCCTeamStatus";
...
import {
  useGetIBCCTeamDetails,
  useGetIBCCteamMembers,
} from "@/hooks/User/useHandleIBCC";
...
function PreliminaryIBCC() {
  const tasks: Task[] = [
    {
      id: 1,
      title: "Proof of Promotion",
      dueDate: "2025-10-17, 23.59 PM",
      programId: 3,
      stage: "PREELIM",
      type: "PROMOTION",
      description:
    ...
    {
      id: 2,
      title: "Preliminary Desk",
      dueDate: "2025-10-25, 23.59 PM",
      programId: 3,
      stage: "PREELIM",
      type: "TASK",
      description:
  ...
  const submissions = useGetSubmission({ event: "IBCC" });
  const { data: teamMembersData } = useGetIBCCteamMembers();
  const { data: teamDetails } = useGetIBCCTeamDetails();
      ...
      <div className="w-full  mx-auto md:p-5 space-y-4 md:space-y-6 mt-4 md:mt-15 z-30 md:min-h-[130vh]">
        <div className="flex flex-col md:flex-row md:mr-5">
          ...
          <div className="flex-1 overflow-auto md:px-20 md:py-6 ">
            ...
            <Timeline />
            <IBCCTeamStatus />
            <Announcement announcementLink={"/users/ibcc/announcement"} />
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between space-y-4 sm:space-y-0">
                      ...
                      <div className="flex flex-col space-y-2">
                        ...
                        {task.title === "Proof of Promotion" && (
                          <button
                            className="inline-flex items-center px-6 py-2 rounded-lg text-[14px] font-bold bg-[#b6e857] text-[#42582b] shadow-lg hover:bg-[#d6ffb6] transition-all duration-300 mb-2"
                ...
                <div className="text-left text-xs sm:text-sm md:text-sm text-[#330084] mb-4 w-full">
                  ...
                  <ol className="list-decimal ml-5 mb-2 space-y-1">
                    <li>
                      ...
                      <a
                        href="https://bit.ly/IBCCSummit2025"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="underline text-[#330084] font-bold"
                      >
                        bit.ly/IBCCSummit2025
                      </a>
                    </li>
                    <li>
                      Proof of reposting the IBCC Open Registration post on your
                      Instagram Story
                    </li>
                    <li>
                    ...
                    <li>
                      ...
                      IBCC Open Registration post
                    </li>
                    <li>
                      Proof of sharing the poster and broadcasting it to at
                      least 3 WhatsApp groups (each group must have a minimum of
                      30 active members)
                    </li>
                  </ol>
...
export default PreliminaryIBCC;
