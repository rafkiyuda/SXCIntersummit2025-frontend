...
import { useCreateIBCCteam } from "@/hooks/User/useHandleIBCC";
import { Toaster } from "react-hot-toast";

const CreateIBCC = () => {
  const [teamName, setTeamName] = useState("");
  const [role] = useState("Team Leader (Auto-filled)");
  const { isLoading, createIBCCteam } = useCreateIBCCteam();

  const handleCreateTeam = () => {
    createIBCCteam({ name: teamName });
  };
